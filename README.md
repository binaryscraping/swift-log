...
If `Logger.main` is used before being initialized that will crash. 

### Destinations

This package provices two destinations out of the box, the `console` and `file`.
...
Boths destinations accepts a `Formatter` parameter to customize the formatting logic of the message, there'a default implementation.
